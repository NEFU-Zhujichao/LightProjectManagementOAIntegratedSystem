...
CREATE TABLE `t_project`  (
    `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
    `projectName` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目名称',
    `projectRequirement` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目需求',
    `projectAdmin` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目提出人',
    `projectCreateTime` date NULL DEFAULT NULL COMMENT '项目提出时间',
    `projectStartTime` date NULL DEFAULT NULL COMMENT '项目开始时间',
    `projectEndTime` date NULL DEFAULT NULL COMMENT '项目结束时间',
    `enabled` tinyint(1) NULL DEFAULT 0 COMMENT '项目是否启用',
    `period`  int NULL  COMMENT '工期',
    PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_project_cost`  (
    `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
    `projectName` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目名称',
    `stageName` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '阶段名称',
    `stageCost` double NULL DEFAULT NULL COMMENT '阶段成本',
    `schedule`  int NULL  COMMENT '进度',
    `days`  int NULL  COMMENT '已进行多少天',
    `period`  int NULL  COMMENT '工期',
    `risk`  double NULL  COMMENT '风险值',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
